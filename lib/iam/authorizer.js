...
// Copied verbatim from https://github.com/awslabs/aws-apigateway-lambda-authorizer-blueprints/blob/master/blueprints/nodejs/index.js
...
function AuthPolicy(principal, awsAccountId, apiOptions) {
  ...
  this.pathRegex = new RegExp('^[/.a-zA-Z0-9-*_]+$'); // these are the internal lists of allowed and denied methods. These are lists
...
AuthPolicy.prototype = function () {
   ...
   * @return {void}
   */
  var addMethod = function addMethod(effect, verb, resource, conditions) {
  ...
  var getEmptyStatement = function getEmptyStatement(effect) {
  ...
  var getStatementsForEffect = function getStatementsForEffect(effect, methods) {
    var statements = [];
